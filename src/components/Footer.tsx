      ...
      <div className="relative section-container max-lg:px-[192px] max-md:px-4 pt-10 max-md:pt-6 pb-20 max-md:pb-10">
        <div className="flex flex-col items-center gap-4 max-md:gap-3">
          ...
          <div className="flex items-center gap-2">
            <a href="https://linkedin.com/in/pndtr" target="_blank" rel="noopener noreferrer" className="w-14 max-md:w-10 h-14 max-md:h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
            ...
            <a href="https://github.com/PhanTrong1008" target="_blank" rel="noopener noreferrer" className="w-14 max-md:w-10 h-14 max-md:h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
            ...
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-14 max-md:w-10 h-14 max-md:h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="white">
